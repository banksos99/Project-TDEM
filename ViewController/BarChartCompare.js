...
export default class PinActivity extends Component {
   ...
   render() {
       ...
       // When data moth both equl 0 not show number 0 : request By
       if (this.props.datalist.previous_month.maxIndividual == 0 &&
           this.props.datalist.request_month.maxIndividual == 0) {
           current1 = '0'
           current2 = '0'
           current3 = '0'
           current4 = '0'
